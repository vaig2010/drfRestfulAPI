...
class UserRegistrationAPITestCase(APITestCase):
    ...
    def test_valid_data_creates_user(self):
        ...
        self.assertEqual(
            self.valid_user_data.get("email"), self.valid_user_data["email"]
        )
        self.assertEqual(
            self.valid_user_data.get("username"), self.valid_user_data["username"]
        )
        self.assertEqual(
            self.valid_user_data.get("password"), self.valid_user_data["password"]
        )
...
class UserLoginSerializerTest(APITestCase):
    ...
    def test_invalid_login(self):
        ...
        self.assertEqual(
            serializer.errors["non_field_errors"][0], "Invalid Credentials"
        )
...
class ReferralCodeSerializerTest(APITestCase):
    ...
    def test_user_without_referral_code_can_create(self):
        ...
        self.assertIn(
            "expiration_date", response.data
        )  # Ensure the expiration date is in the response
